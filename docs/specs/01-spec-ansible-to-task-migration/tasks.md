...
- [x] 7. **Implement `dotfiles:sync` task**
...
- [x] 8. **Implement `shell:zshrc` task**
...
- [x] 9. **Implement persona-aware git config**
...
- [x] 10. **Implement persona-aware SSH config**
...
- [x] 11. **Secrets loading + validation**
...
- [x] 12. **Extract current Windsurf settings + AI chat configuration**
...
- [x] 13. **Move iTerm2 profile to top level**
...
- [x] 14. **Implement `ides:windsurf` task**
