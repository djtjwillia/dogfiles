# Eval Scenarios — synod-wayne (ux)

> UX/UI & accessibility scenarios for `synod-wayne`. Synthetic inputs only.
...
- **Expected route:** synod-wayne for the experience, looping in **synod-marsh** (auth state / sensitive data).
...
- **Expected route:** synod-wayne assesses UX impact, looping in **synod-wax** for the underlying defect.
